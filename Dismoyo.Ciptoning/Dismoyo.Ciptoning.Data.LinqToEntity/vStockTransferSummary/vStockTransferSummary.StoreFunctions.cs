...
namespace Dismoyo.Ciptoning.Data
{
    ...
    public partial class StoreFunctionsDataContext : DataContext
    {
        ...
        #region fStockTransferSummary

        [DbFunction("StoreFunctionsDataContext", "fStockTransferSummary")]
        public IQueryable<vStockTransferSummary> fStockTransferSummary(
            Guid? p_DocumentID,
            int? p_ProductID,
        ...
        {
            return OrderQuery<vStockTransferSummary>(((IObjectContextAdapter)this).ObjectContext
                .CreateQuery<vStockTransferSummary>(string.Format(@"
                [{0}].[fStockTransferSummary]
                ( 
                    @DocumentID,
                    @ProductID,
                    @ProductCode,
