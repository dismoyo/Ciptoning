...
namespace Dismoyo.Ciptoning.Data
{
    ...
    public partial class StoreFunctionsDataContext : DataContext
    {
        ...
        #region fSalesOrderReturnSummary

        [DbFunction("StoreFunctionsDataContext", "fSalesOrderReturnSummary")]
        public IQueryable<vSalesOrderReturnSummary> fSalesOrderReturnSummary(
            Guid? p_DocumentID,
            int? p_ProductID,
        ...
        {
            return OrderQuery<vSalesOrderReturnSummary>(((IObjectContextAdapter)this).ObjectContext
                .CreateQuery<vSalesOrderReturnSummary>(string.Format(@"
                [{0}].[fSalesOrderReturnSummary]
                ( 
                    @DocumentID,
                    @ProductID,
                    @ProductCode,
