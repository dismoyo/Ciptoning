...
namespace Dismoyo.Ciptoning.Data
{
    ...
    public partial class StoreFunctionsDataContext : DataContext
    {
        ...
        [DbFunction("StoreFunctionsDataContext", "fStockOpname")]
        public IQueryable<vStockOpname> fStockOpname(
            Guid? p_DocumentID,
        ...
        {
            return OrderQuery<vStockOpname>(((IObjectContextAdapter)this).ObjectContext
                .CreateQuery<vStockOpname>(string.Format(@"
                [{0}].[fStockOpname]
                ( 
                    @DocumentID,
                    @DocumentCode,
