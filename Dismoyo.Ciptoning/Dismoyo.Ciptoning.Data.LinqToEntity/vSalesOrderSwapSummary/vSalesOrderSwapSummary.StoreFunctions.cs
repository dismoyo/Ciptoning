...
namespace Dismoyo.Ciptoning.Data
{
    ...
    public partial class StoreFunctionsDataContext : DataContext
    {
        ...
        #region fSalesOrderSwapSummary

        [DbFunction("StoreFunctionsDataContext", "fSalesOrderSwapSummary")]
        public IQueryable<vSalesOrderSwapSummary> fSalesOrderSwapSummary(
            Guid? p_DocumentID,
            int? p_ProductID,
        ...
        {
            return OrderQuery<vSalesOrderSwapSummary>(((IObjectContextAdapter)this).ObjectContext
                .CreateQuery<vSalesOrderSwapSummary>(string.Format(@"
                [{0}].[fSalesOrderSwapSummary]
                ( 
                    @DocumentID,
                    @ProductID,
                    @ProductCode,
