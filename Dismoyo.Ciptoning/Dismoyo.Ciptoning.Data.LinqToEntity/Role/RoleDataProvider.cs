...
namespace Dismoyo.Ciptoning.Data
{
    ...
    public partial class RoleDataProvider : DefaultTableDataProvider<Role>, IRoleDataProvider
    {
        ...
        public Role GetDataByName(string name)
        {
        ...
        protected override void OnBeginInsertData(BeginOperationDataEventArgs<Role> e)
        {
        ...
        protected override void OnBeginUpdateData(BeginOperationDataEventArgs<Role> e)
        {
