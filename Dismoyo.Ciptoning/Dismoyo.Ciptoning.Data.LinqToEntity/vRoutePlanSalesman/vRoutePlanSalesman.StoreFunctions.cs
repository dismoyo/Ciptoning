...
namespace Dismoyo.Ciptoning.Data
{
    ...
    public partial class StoreFunctionsDataContext : DataContext
    {
        ...
        #region fRoutePlanSalesman

        [DbFunction("StoreFunctionsDataContext", "fRoutePlanSalesman")]
        public IQueryable<vRoutePlanSalesman> fRoutePlanSalesman(
            Guid? p_SalesmanID,
            Guid? p_CustomerID,
            int? p_WeekID,
            int? p_DayID,
        ...
        {
            return OrderQuery<vRoutePlanSalesman>(((IObjectContextAdapter)this).ObjectContext
                .CreateQuery<vRoutePlanSalesman>(string.Format(@"
                [{0}].[fRoutePlanSalesman]
                ( 
                    @SalesmanID,
                    @CustomerID,
                    @WeekID,
