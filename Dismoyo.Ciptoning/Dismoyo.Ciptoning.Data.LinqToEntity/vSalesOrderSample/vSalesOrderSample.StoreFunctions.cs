...
namespace Dismoyo.Ciptoning.Data
{
    ...
    public partial class StoreFunctionsDataContext : DataContext
    {
        ...
        #region fSalesOrderSample

        [DbFunction("StoreFunctionsDataContext", "fSalesOrderSample")]
        public IQueryable<vSalesOrderSample> fSalesOrderSample(
            Guid? p_DocumentID,
            string p_DocumentCode,
            DateTime? p_TransactionDateFrom,
            DateTime? p_TransactionDateTo,
            Guid? p_PODocumentID,
            string p_PODocumentCode,
            Guid? p_SalesmanID,
            ...
            Guid? p_InvoiceDocumentID,
            string p_InvoiceDocumentCode,
        ...
        {
            return OrderQuery<vSalesOrderSample>(((IObjectContextAdapter)this).ObjectContext
                .CreateQuery<vSalesOrderSample>(string.Format(@"
                [{0}].[fSalesOrderSample]
                ( 
                    @DocumentID,
                    @DocumentCode,
                ...
                DefaultDataContext.CreateParameter("PODocumentID", typeof(Guid?), p_PODocumentID),
                DefaultDataContext.CreateParameter("PODocumentCode", typeof(string), p_PODocumentCode),
                ...
                DefaultDataContext.CreateParameter("InvoiceDocumentID", typeof(Guid?), p_InvoiceDocumentID),
                DefaultDataContext.CreateParameter("InvoiceDocumentCode", typeof(string), p_InvoiceDocumentCode),
