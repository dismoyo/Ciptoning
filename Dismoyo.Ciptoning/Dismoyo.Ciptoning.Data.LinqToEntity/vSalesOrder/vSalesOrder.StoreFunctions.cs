...
namespace Dismoyo.Ciptoning.Data
{
    ...
    public partial class StoreFunctionsDataContext : DataContext
    {
        ...
        [DbFunction("StoreFunctionsDataContext", "fSalesOrder")]
        public IQueryable<vSalesOrder> fSalesOrder(
            Guid? p_DocumentID,
        ...
        {
            return OrderQuery<vSalesOrder>(((IObjectContextAdapter)this).ObjectContext
                .CreateQuery<vSalesOrder>(string.Format(@"
                [{0}].[fSalesOrder]
                ( 
                    @DocumentID,
                    @DocumentCode,
