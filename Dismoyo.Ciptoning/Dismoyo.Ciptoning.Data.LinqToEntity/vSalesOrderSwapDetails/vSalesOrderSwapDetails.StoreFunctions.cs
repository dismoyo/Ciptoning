...
namespace Dismoyo.Ciptoning.Data
{
    ...
    public partial class StoreFunctionsDataContext : DataContext
    {
        ...
        #region fSalesOrderSwapDetails

        [DbFunction("StoreFunctionsDataContext", "fSalesOrderSwapDetails")]
        ...
        {
            return OrderQuery<vSalesOrderSwapDetails>(((IObjectContextAdapter)this).ObjectContext
                .CreateQuery<vSalesOrderSwapDetails>(string.Format(@"
                [{0}].[fSalesOrderSwapDetails]
                ( 
                    @DocumentID,
                    @ProductID,
                    @ProductLotID,
