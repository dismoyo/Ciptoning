...
namespace Dismoyo.Ciptoning.Data
{
    ...
    public partial class StoreFunctionsDataContext : DataContext
    {
        ...
        #region fStockChangesDetails

        [DbFunction("StoreFunctionsDataContext", "fStockChangesDetails")]
        ...
        {
            return OrderQuery<vStockChangesDetails>(((IObjectContextAdapter)this).ObjectContext
                .CreateQuery<vStockChangesDetails>(string.Format(@"
                [{0}].[fStockChangesDetails]
                ( 
                    @DocumentID,
                    @ProductID,
                    @ProductLotID,
