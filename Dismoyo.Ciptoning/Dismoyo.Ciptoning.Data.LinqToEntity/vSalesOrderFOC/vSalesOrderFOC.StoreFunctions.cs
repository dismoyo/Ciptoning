...
namespace Dismoyo.Ciptoning.Data
{
    ...
    public partial class StoreFunctionsDataContext : DataContext
    {
        ...
        #region fSalesOrderFOC

        [DbFunction("StoreFunctionsDataContext", "fSalesOrderFOC")]
        public IQueryable<vSalesOrderFOC> fSalesOrderFOC(
            Guid? p_DocumentID,
        ...
        {
            return OrderQuery<vSalesOrderFOC>(((IObjectContextAdapter)this).ObjectContext
                .CreateQuery<vSalesOrderFOC>(string.Format(@"
                [{0}].[fSalesOrderFOC]
                ( 
                    @DocumentID,
                    @DocumentCode,
