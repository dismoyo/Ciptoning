...
namespace Dismoyo.Ciptoning.Data
{
    ...
    public partial class StoreFunctionsDataContext : DataContext
    {
        ...
        [DbFunction("StoreFunctionsDataContext", "fStockView")]
        public IQueryable<vStockView> fStockView(
            Guid? p_WarehouseID,
        ...
        {
            return OrderQuery<vStockView>(((IObjectContextAdapter)this).ObjectContext
                .CreateQuery<vStockView>(string.Format(@"
                [{0}].[fStockView]
                ( 
                    @WarehouseID,
                    @TransactionDate,
                ...
                DefaultDataContext.CreateParameter("ProductPack", typeof(string), p_ProductPack),
                DefaultDataContext.CreateParameter("ProductShortName", typeof(string), p_ProductShortName),
                DefaultDataContext.CreateParameter("ProductUOM", typeof(string), p_ProductUOM),
