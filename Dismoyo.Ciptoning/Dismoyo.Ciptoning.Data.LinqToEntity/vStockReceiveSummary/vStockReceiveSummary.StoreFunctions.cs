...
namespace Dismoyo.Ciptoning.Data
{
    ...
    public partial class StoreFunctionsDataContext : DataContext
    {
        ...
        #region fStockReceiveSummary

        [DbFunction("StoreFunctionsDataContext", "fStockReceiveSummary")]
        public IQueryable<vStockReceiveSummary> fStockReceiveSummary(
            Guid? p_DocumentID,
            int? p_ProductID,
        ...
        {
            return OrderQuery<vStockReceiveSummary>(((IObjectContextAdapter)this).ObjectContext
                .CreateQuery<vStockReceiveSummary>(string.Format(@"
                [{0}].[fStockReceiveSummary]
                ( 
                    @DocumentID,
                    @ProductID,
                    @ProductCode,
