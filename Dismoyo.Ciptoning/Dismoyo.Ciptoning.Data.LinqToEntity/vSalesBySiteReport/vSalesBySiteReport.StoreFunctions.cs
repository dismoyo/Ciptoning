...
namespace Dismoyo.Ciptoning.Data
{
    ...
    public partial class StoreFunctionsDataContext : DataContext
    {
        ...
        #region fSalesBySiteReport

        [DbFunction("StoreFunctionsDataContext", "fSalesBySiteReport")]
        public IQueryable<vSalesBySiteReport> fSalesBySiteReport(
            ...
            int? p_ProductID)
        {
            return OrderQuery<vSalesBySiteReport>(((IObjectContextAdapter)this).ObjectContext
                .CreateQuery<vSalesBySiteReport>(string.Format(@"
                [{0}].[fSalesBySiteReport]
                ( 
                    @ReportDateFrom,
                    @ReportDateTo,
                    @CategorySiteCode,
