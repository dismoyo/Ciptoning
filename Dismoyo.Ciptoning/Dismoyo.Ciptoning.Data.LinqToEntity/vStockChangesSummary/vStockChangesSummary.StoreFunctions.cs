...
namespace Dismoyo.Ciptoning.Data
{
    ...
    public partial class StoreFunctionsDataContext : DataContext
    {
        ...
        #region fStockChangesSummary

        [DbFunction("StoreFunctionsDataContext", "fStockChangesSummary")]
        public IQueryable<vStockChangesSummary> fStockChangesSummary(
            Guid? p_DocumentID,
            int? p_ProductID,
        ...
        {
            return OrderQuery<vStockChangesSummary>(((IObjectContextAdapter)this).ObjectContext
                .CreateQuery<vStockChangesSummary>(string.Format(@"
                [{0}].[fStockChangesSummary]
                ( 
                    @DocumentID,
                    @ProductID,
                    @ProductCode,
