...
namespace Dismoyo.Ciptoning.Data
{
    ...
    public partial class StoreFunctionsDataContext : DataContext
    {
        ...
        #region fSalesOrderSampleSummary

        [DbFunction("StoreFunctionsDataContext", "fSalesOrderSampleSummary")]
        public IQueryable<vSalesOrderSampleSummary> fSalesOrderSampleSummary(
            Guid? p_DocumentID,
            int? p_ProductID,
        ...
        {
            return OrderQuery<vSalesOrderSampleSummary>(((IObjectContextAdapter)this).ObjectContext
                .CreateQuery<vSalesOrderSampleSummary>(string.Format(@"
                [{0}].[fSalesOrderSampleSummary]
                ( 
                    @DocumentID,
                    @ProductID,
                    @ProductCode,
