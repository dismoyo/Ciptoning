...
namespace Dismoyo.Ciptoning.Data
{
    ...
    public partial class StoreFunctionsDataContext : DataContext
    {
        ...
        #region fSalesOrderFOCSummary

        [DbFunction("StoreFunctionsDataContext", "fSalesOrderFOCSummary")]
        public IQueryable<vSalesOrderFOCSummary> fSalesOrderFOCSummary(
            Guid? p_DocumentID,
            int? p_ProductID,
        ...
        {
            return OrderQuery<vSalesOrderFOCSummary>(((IObjectContextAdapter)this).ObjectContext
                .CreateQuery<vSalesOrderFOCSummary>(string.Format(@"
                [{0}].[fSalesOrderFOCSummary]
                ( 
                    @DocumentID,
                    @ProductID,
                    @ProductCode,
