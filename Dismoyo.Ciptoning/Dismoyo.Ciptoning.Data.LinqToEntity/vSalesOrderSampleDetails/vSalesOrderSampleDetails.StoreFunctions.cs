...
namespace Dismoyo.Ciptoning.Data
{
    ...
    public partial class StoreFunctionsDataContext : DataContext
    {
        ...
        #region fSalesOrderSampleDetails

        [DbFunction("StoreFunctionsDataContext", "fSalesOrderSampleDetails")]
        public IQueryable<vSalesOrderSampleDetails> fSalesOrderSampleDetails(
            Guid? p_DocumentID,
            int? p_ProductID,
            int? p_ProductLotID,
        ...
        {
            return OrderQuery<vSalesOrderSampleDetails>(((IObjectContextAdapter)this).ObjectContext
                .CreateQuery<vSalesOrderSampleDetails>(string.Format(@"
                [{0}].[fSalesOrderSampleDetails]
                ( 
                    @DocumentID,
                    @ProductID,
                    @ProductLotID,
