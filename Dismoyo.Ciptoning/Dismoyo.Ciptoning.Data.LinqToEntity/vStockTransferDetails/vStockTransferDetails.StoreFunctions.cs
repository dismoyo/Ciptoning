...
namespace Dismoyo.Ciptoning.Data
{
    ...
    public partial class StoreFunctionsDataContext : DataContext
    {
        ...
        #region fStockTransferDetails

        [DbFunction("StoreFunctionsDataContext", "fStockTransferDetails")]
        public IQueryable<vStockTransferDetails> fStockTransferDetails(
            Guid? p_DocumentID,
            int? p_ProductID,
            int? p_ProductLotID,
        ...
        {
            return OrderQuery<vStockTransferDetails>(((IObjectContextAdapter)this).ObjectContext
                .CreateQuery<vStockTransferDetails>(string.Format(@"
                [{0}].[fStockTransferDetails]
                ( 
                    @DocumentID,
                    @ProductID,
                    @ProductLotID,
