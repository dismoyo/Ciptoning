...
namespace Dismoyo.Ciptoning.Data
{
    ...
    public partial class StoreFunctionsDataContext : DataContext
    {
        ...
        #region fSalesOrderSummary

        [DbFunction("StoreFunctionsDataContext", "fSalesOrderSummary")]
        public IQueryable<vSalesOrderSummary> fSalesOrderSummary(
            Guid? p_DocumentID,
            int? p_ProductID,
        ...
        {
            return OrderQuery<vSalesOrderSummary>(((IObjectContextAdapter)this).ObjectContext
                .CreateQuery<vSalesOrderSummary>(string.Format(@"
                [{0}].[fSalesOrderSummary]
                ( 
                    @DocumentID,
                    @ProductID,
                    @ProductCode,
