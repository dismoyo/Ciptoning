...
namespace Dismoyo.Ciptoning.Data
{
    ...
    public partial class StoreFunctionsDataContext : DataContext
    {
        ...
        #region fStockDisposal

        [DbFunction("StoreFunctionsDataContext", "fStockDisposal")]
        public IQueryable<vStockDisposal> fStockDisposal(
            Guid? p_DocumentID,
        ...
        {
            return OrderQuery<vStockDisposal>(((IObjectContextAdapter)this).ObjectContext
                .CreateQuery<vStockDisposal>(string.Format(@"
                [{0}].[fStockDisposal]
                ( 
                    @DocumentID,
                    @DocumentCode,
