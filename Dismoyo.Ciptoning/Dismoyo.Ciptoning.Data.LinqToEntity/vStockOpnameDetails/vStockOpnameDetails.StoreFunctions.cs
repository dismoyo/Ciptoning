...
namespace Dismoyo.Ciptoning.Data
{
    ...
    public partial class StoreFunctionsDataContext : DataContext
    {
        ...
        #region fStockOpnameDetails

        [DbFunction("StoreFunctionsDataContext", "fStockOpnameDetails")]
        public IQueryable<vStockOpnameDetails> fStockOpnameDetails(
            Guid? p_DocumentID,
            int? p_ProductID,
            int? p_ProductLotID,
        ...
        {
            return OrderQuery<vStockOpnameDetails>(((IObjectContextAdapter)this).ObjectContext
                .CreateQuery<vStockOpnameDetails>(string.Format(@"
                [{0}].[fStockOpnameDetails]
                ( 
                    @DocumentID,
                    @ProductID,
                    @ProductLotID,
