...
namespace Dismoyo.Ciptoning.Data
{
    ...
    public partial class StoreFunctionsDataContext : DataContext
    {
        ...
        #region fSalesOrderFOCDetails

        [DbFunction("StoreFunctionsDataContext", "fSalesOrderFOCDetails")]
        public IQueryable<vSalesOrderFOCDetails> fSalesOrderFOCDetails(
            Guid? p_DocumentID,
            int? p_ProductID,
            int? p_ProductLotID,
        ...
        {
            return OrderQuery<vSalesOrderFOCDetails>(((IObjectContextAdapter)this).ObjectContext
                .CreateQuery<vSalesOrderFOCDetails>(string.Format(@"
                [{0}].[fSalesOrderFOCDetails]
                ( 
                    @DocumentID,
                    @ProductID,
                    @ProductLotID,
