...
namespace Dismoyo.Ciptoning.Data
{
    ...
    public partial class StoreFunctionsDataContext : DataContext
    {
        ...
        #region fStockDisposalDetails

        [DbFunction("StoreFunctionsDataContext", "fStockDisposalDetails")]
        ...
        {
            return OrderQuery<vStockDisposalDetails>(((IObjectContextAdapter)this).ObjectContext
                .CreateQuery<vStockDisposalDetails>(string.Format(@"
                [{0}].[fStockDisposalDetails]
                ( 
                    @DocumentID,
                    @ProductID,
                    @ProductLotID,
