...
namespace Dismoyo.Ciptoning.Data
{
    ...
    public partial class StoreFunctionsDataContext : DataContext
    {
        ...
        #region fSalesOrderReturnDetails

        [DbFunction("StoreFunctionsDataContext", "fSalesOrderReturnDetails")]
        public IQueryable<vSalesOrderReturnDetails> fSalesOrderReturnDetails(
            Guid? p_DocumentID,
            int? p_ProductID,
            int? p_ProductLotID,
        ...
        {
            return OrderQuery<vSalesOrderReturnDetails>(((IObjectContextAdapter)this).ObjectContext
                .CreateQuery<vSalesOrderReturnDetails>(string.Format(@"
                [{0}].[fSalesOrderReturnDetails]
                ( 
                    @DocumentID,
                    @ProductID,
                    @ProductLotID,
