...
namespace Dismoyo.Ciptoning.Data
{
    ...
    public partial class StoreFunctionsDataContext : DataContext
    {
        ...
        #region fSalesOrderReturn

        [DbFunction("StoreFunctionsDataContext", "fSalesOrderReturn")]
        public IQueryable<vSalesOrderReturn> fSalesOrderReturn(
            Guid? p_DocumentID,
        ...
        {
            return OrderQuery<vSalesOrderReturn>(((IObjectContextAdapter)this).ObjectContext
                .CreateQuery<vSalesOrderReturn>(string.Format(@"
                [{0}].[fSalesOrderReturn]
                ( 
                    @DocumentID,
                    @DocumentCode,
                ...
                DefaultDataContext.CreateParameter("ReasonID", typeof(int?), p_ReasonID),
