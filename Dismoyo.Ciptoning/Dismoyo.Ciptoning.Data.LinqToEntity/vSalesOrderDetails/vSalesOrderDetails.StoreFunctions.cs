...
namespace Dismoyo.Ciptoning.Data
{
    ...
    public partial class StoreFunctionsDataContext : DataContext
    {
        ...
        #region fSalesOrderDetails

        [DbFunction("StoreFunctionsDataContext", "fSalesOrderDetails")]
        public IQueryable<vSalesOrderDetails> fSalesOrderDetails(
            Guid? p_DocumentID,
            int? p_ProductID,
            int? p_ProductLotID,
        ...
        {
            return OrderQuery<vSalesOrderDetails>(((IObjectContextAdapter)this).ObjectContext
                .CreateQuery<vSalesOrderDetails>(string.Format(@"
                [{0}].[fSalesOrderDetails]
                ( 
                    @DocumentID,
                    @ProductID,
                    @ProductLotID,
