...
namespace Dismoyo.Ciptoning.Web.Reports
{
    ...
    public partial class SalesByChannelReport : System.Web.UI.Page
    {
        ...
        {
            var report = new SalesByChannelReportControl();
            ...
            if ((reportGroupBy.HasValue) && (reportGroupBy.Value == 2))
            {
                ...
                dataSource = DefaultDataContext.DataContext.fSalesByChannelByBrandReport(
                    reportDateFrom,
                    reportDateTo,
                    null,
                    territoryID,
                    ...
                    null,
                    null)
                    .OrderBy(p => p.CategoryChannelCode)
            ...
            else
            {
                ...
                dataSource = DefaultDataContext.DataContext.fSalesByChannelReport(
                    reportDateFrom,
                    reportDateTo,
                    null,
                    territoryID,
            ...
            report.tableDataChannel.DataBindings.Add(new XRBinding("Text", dataSource, "CategoryChannel"));
