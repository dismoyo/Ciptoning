...
namespace Dismoyo.Ciptoning.Web.Reports
{
    ...
    public partial class SalesByOrderReport : System.Web.UI.Page
    {
        ...
        {
            var report = new SalesByOrderReportControl();
            ...
            dataSource = DefaultDataContext.GetDataTable(@"EXEC [dbo].[spSalesByOrderReport]
                @ReportDateFrom,
                @ReportDateTo,
                @TerritoryID,
                @RegionID,
