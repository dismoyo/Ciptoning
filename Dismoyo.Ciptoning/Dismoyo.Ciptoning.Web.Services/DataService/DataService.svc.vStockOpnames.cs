...
namespace Dismoyo.Ciptoning.Web.Services
{
    ...
    public partial class DataService : EntityFrameworkDataService<StoreFunctionsDataContext>, IServiceProvider
    {
        ...
        [QueryInterceptor("vStockOpnames")]
        public Expression<Func<vStockOpname, bool>> OnQueryvStockOpnames()
        {
            return (p => true);
        }
        
        [ChangeInterceptor("vStockOpnames")]
        public void OnChangevStockOpnames(vStockOpname data, UpdateOperations operations)
        {
            var dataProvider = DataConfiguration.GetDefaultDataProvider<IvStockOpnameDataProvider>();
        ...
        [WebGet]
        public IQueryable<vStockOpname> fStockOpnames()
        {
            return CurrentDataSource.fStockOpname(
