...
namespace Dismoyo.Ciptoning.Web.Services
{
    ...
    public partial class DataService : EntityFrameworkDataService<StoreFunctionsDataContext>, IServiceProvider
    {
        ...
        [QueryInterceptor("vSalesOrderDetails")]
        public Expression<Func<vSalesOrderDetails, bool>> OnQueryvSalesOrderDetails()
        {
            return (p => true);
        }

        [ChangeInterceptor("vSalesOrderDetails")]
        public void OnChangevSalesOrderDetails(vSalesOrderDetails data, UpdateOperations operations)
        {
            if (ValidateSegment("vSalesOrderDetails"))
            {
                var dataProvider = DataConfiguration.GetDefaultDataProvider<IvSalesOrderDetailsDataProvider>();
        ...
        {
            return CurrentDataSource.fSalesOrderDetails(
