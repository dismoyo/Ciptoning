...
namespace Dismoyo.Ciptoning.Web.Services
{
    ...
    public partial class DataService : EntityFrameworkDataService<StoreFunctionsDataContext>, IServiceProvider
    {
        ...
        [QueryInterceptor("vStockOpnameDetails")]
        public Expression<Func<vStockOpnameDetails, bool>> OnQueryvStockOpnameDetails()
        {
            return (p => true);
        }

        [ChangeInterceptor("vStockOpnameDetails")]
        public void OnChangevStockOpnameDetails(vStockOpnameDetails data, UpdateOperations operations)
        {
            if (ValidateSegment("vStockOpnameDetails"))
            {
                var dataProvider = DataConfiguration.GetDefaultDataProvider<IvStockOpnameDetailsDataProvider>();
        ...
        {
            return CurrentDataSource.fStockOpnameDetails(
