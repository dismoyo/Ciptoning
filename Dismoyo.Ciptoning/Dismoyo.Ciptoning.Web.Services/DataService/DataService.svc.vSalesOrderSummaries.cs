...
namespace Dismoyo.Ciptoning.Web.Services
{
    ...
    public partial class DataService : EntityFrameworkDataService<StoreFunctionsDataContext>, IServiceProvider
    {
        ...
        [QueryInterceptor("vSalesOrderSummaries")]
        public Expression<Func<vSalesOrderSummary, bool>> OnQueryvSalesOrderSummaries()
        {
            return (p => true);
        }

        [ChangeInterceptor("vSalesOrderSummaries")]
        public void OnChangevSalesOrderSummaries(vSalesOrderSummary data, UpdateOperations operations)
        {
            if (ValidateSegment("vSalesOrderSummaries"))
            {
                var dataProvider = DataConfiguration.GetDefaultDataProvider<IvSalesOrderSummaryDataProvider>();
        ...
        [WebGet]
        public IQueryable<vSalesOrderSummary> fSalesOrderSummaries()
        {
            return CurrentDataSource.fSalesOrderSummary(
