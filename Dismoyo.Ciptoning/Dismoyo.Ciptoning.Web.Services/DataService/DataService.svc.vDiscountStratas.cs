...
namespace Dismoyo.Ciptoning.Web.Services
{
    ...
    public partial class DataService : EntityFrameworkDataService<StoreFunctionsDataContext>, IServiceProvider
    {
        ...
        [QueryInterceptor("vDiscountStratas")]
        public Expression<Func<vDiscountStrata, bool>> OnQueryvDiscountStratas()
        {
            return (p => !p.IsDeleted);
        }

        [ChangeInterceptor("vDiscountStratas")]
        public void OnChangevDiscountStratas(vDiscountStrata data, UpdateOperations operations)
        {
            var dataProvider = DataConfiguration.GetDefaultDataProvider<IvDiscountStrataDataProvider>();
