...
namespace Dismoyo.Ciptoning.Web.Services
{
    ...
    public partial class DataService : EntityFrameworkDataService<StoreFunctionsDataContext>, IServiceProvider
    {
        ...
        [QueryInterceptor("vUserRoleAlls")]
        public Expression<Func<vUserRoleAll, bool>> OnQueryvUserRoleAlls()
        {
            return (p => !p.IsDeleted);
        }

        [ChangeInterceptor("vUserRoleAlls")]
        public void OnChangevUserRoleAlls(vUserRoleAll data, UpdateOperations operations)
        {
            var dataProvider = DataConfiguration.GetDefaultDataProvider<IvUserRoleAllDataProvider>();
