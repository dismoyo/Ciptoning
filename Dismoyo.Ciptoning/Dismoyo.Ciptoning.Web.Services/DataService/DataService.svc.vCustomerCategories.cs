...
namespace Dismoyo.Ciptoning.Web.Services
{
    ...
    public partial class DataService : EntityFrameworkDataService<StoreFunctionsDataContext>, IServiceProvider
    {
        ...
        [QueryInterceptor("vCustomerCategories")]
        public Expression<Func<vCustomerCategory, bool>> OnQueryvCustomerCategories()
        {
            return (p => !p.IsDeleted);
        }

        [ChangeInterceptor("vCustomerCategories")]
        public void OnChangevCustomerCategories(vCustomerCategory data, UpdateOperations operations)
        {
            var dataProvider = DataConfiguration.GetDefaultDataProvider<IvCustomerCategoryDataProvider>();
