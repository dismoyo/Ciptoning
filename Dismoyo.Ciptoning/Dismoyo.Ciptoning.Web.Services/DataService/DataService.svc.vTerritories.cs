...
namespace Dismoyo.Ciptoning.Web.Services
{
    ...
    public partial class DataService : EntityFrameworkDataService<StoreFunctionsDataContext>, IServiceProvider
    {
        ...
        [QueryInterceptor("vTerritories")]
        public Expression<Func<vTerritory, bool>> OnQueryvTerritories()
        {
            return (p => !p.IsDeleted);
        }

        [ChangeInterceptor("vTerritories")]
        public void OnChangevTerritories(vTerritory data, UpdateOperations operations)
        {
            var dataProvider = DataConfiguration.GetDefaultDataProvider<IvTerritoryDataProvider>();
