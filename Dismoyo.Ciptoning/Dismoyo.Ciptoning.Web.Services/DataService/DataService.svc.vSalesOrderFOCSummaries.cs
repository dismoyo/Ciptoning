...
namespace Dismoyo.Ciptoning.Web.Services
{
    ...
    public partial class DataService : EntityFrameworkDataService<StoreFunctionsDataContext>, IServiceProvider
    {
        ...
        [QueryInterceptor("vSalesOrderFOCSummaries")]
        public Expression<Func<vSalesOrderFOCSummary, bool>> OnQueryvSalesOrderFOCSummaries()
        {
            return (p => true);
        }

        [ChangeInterceptor("vSalesOrderFOCSummaries")]
        public void OnChangevSalesOrderFOCSummaries(vSalesOrderFOCSummary data, UpdateOperations operations)
        {
            if (ValidateSegment("vSalesOrderFOCSummaries"))
            {
                var dataProvider = DataConfiguration.GetDefaultDataProvider<IvSalesOrderFOCSummaryDataProvider>();
        ...
        [WebGet]
        public IQueryable<vSalesOrderFOCSummary> fSalesOrderFOCSummaries()
        {
            return CurrentDataSource.fSalesOrderFOCSummary(
