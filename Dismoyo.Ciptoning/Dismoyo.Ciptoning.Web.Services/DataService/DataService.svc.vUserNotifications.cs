...
namespace Dismoyo.Ciptoning.Web.Services
{
    ...
    public partial class DataService : EntityFrameworkDataService<StoreFunctionsDataContext>, IServiceProvider
    {
        ...
        [QueryInterceptor("vUserNotifications")]
        public Expression<Func<vUserNotification, bool>> OnQueryvUserNotifications()
        {
            return (p => true);
        }

        [ChangeInterceptor("vUserNotifications")]
        public void OnChangevUserNotifications(vUserNotification data, UpdateOperations operations)
        {
            var dataProvider = DataConfiguration.GetDefaultDataProvider<IvUserNotificationDataProvider>();
