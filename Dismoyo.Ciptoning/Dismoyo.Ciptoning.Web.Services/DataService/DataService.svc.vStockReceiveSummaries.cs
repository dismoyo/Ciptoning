...
namespace Dismoyo.Ciptoning.Web.Services
{
    ...
    public partial class DataService : EntityFrameworkDataService<StoreFunctionsDataContext>, IServiceProvider
    {
        ...
        [QueryInterceptor("vStockReceiveSummaries")]
        public Expression<Func<vStockReceiveSummary, bool>> OnQueryvStockReceiveSummaries()
        {
            return (p => true);
        }

        [ChangeInterceptor("vStockReceiveSummaries")]
        public void OnChangevStockReceiveSummaries(vStockReceiveSummary data, UpdateOperations operations)
        {
            if (ValidateSegment("vStockReceiveSummaries"))
            {
                var dataProvider = DataConfiguration.GetDefaultDataProvider<IvStockReceiveSummaryDataProvider>();
        ...
        [WebGet]
        public IQueryable<vStockReceiveSummary> fStockReceiveSummaries()
        {
            return CurrentDataSource.fStockReceiveSummary(
