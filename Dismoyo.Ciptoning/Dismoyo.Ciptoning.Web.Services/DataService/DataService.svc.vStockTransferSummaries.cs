...
namespace Dismoyo.Ciptoning.Web.Services
{
    ...
    public partial class DataService : EntityFrameworkDataService<StoreFunctionsDataContext>, IServiceProvider
    {
        ...
        [QueryInterceptor("vStockTransferSummaries")]
        public Expression<Func<vStockTransferSummary, bool>> OnQueryvStockTransferSummaries()
        {
            return (p => true);
        }

        [ChangeInterceptor("vStockTransferSummaries")]
        public void OnChangevStockTransferSummaries(vStockTransferSummary data, UpdateOperations operations)
        {
            if (ValidateSegment("vStockTransferSummaries"))
            {
                var dataProvider = DataConfiguration.GetDefaultDataProvider<IvStockTransferSummaryDataProvider>();
        ...
        [WebGet]
        public IQueryable<vStockTransferSummary> fStockTransferSummaries()
        {
            return CurrentDataSource.fStockTransferSummary(
