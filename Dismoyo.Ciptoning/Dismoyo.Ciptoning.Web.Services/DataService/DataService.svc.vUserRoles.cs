...
namespace Dismoyo.Ciptoning.Web.Services
{
    ...
    public partial class DataService : EntityFrameworkDataService<StoreFunctionsDataContext>, IServiceProvider
    {
        ...
        [QueryInterceptor("vUserRoles")]
        public Expression<Func<vUserRole, bool>> OnQueryvUserRoles()
        {
            return (p => true);
        }

        [ChangeInterceptor("vUserRoles")]
        public void OnChangevUserRoles(vUserRole data, UpdateOperations operations)
        {
            if (ValidateSegment("vUserRoles"))
            {
                var dataProvider = DataConfiguration.GetDefaultDataProvider<IvUserRoleDataProvider>();
