...
namespace Dismoyo.Ciptoning.Web.Services
{
    ...
    public partial class DataService : EntityFrameworkDataService<StoreFunctionsDataContext>, IServiceProvider
    {
        ...
        [QueryInterceptor("vStockReceives")]
        public Expression<Func<vStockReceive, bool>> OnQueryvStockReceives()
        {
            return (p => true);
        }

        [ChangeInterceptor("vStockReceives")]
        public void OnChangevStockReceives(vStockReceive data, UpdateOperations operations)
        {
            var dataProvider = DataConfiguration.GetDefaultDataProvider<IvStockReceiveDataProvider>();
        ...
        [WebGet]
        public IQueryable<vStockReceive> fStockReceives()
        {
            return CurrentDataSource.fStockReceive(
