...
namespace Dismoyo.Ciptoning.Web.Services
{
    ...
    public partial class DataService : EntityFrameworkDataService<StoreFunctionsDataContext>, IServiceProvider
    {
        ...
        [QueryInterceptor("vStockOpnameSummaries")]
        public Expression<Func<vStockOpnameSummary, bool>> OnQueryvStockOpnameSummaries()
        {
            return (p => true);
        }

        [ChangeInterceptor("vStockOpnameSummaries")]
        public void OnChangevStockOpnameSummaries(vStockOpnameSummary data, UpdateOperations operations)
        {
            if (ValidateSegment("vStockOpnameSummaries"))
            {
                var dataProvider = DataConfiguration.GetDefaultDataProvider<IvStockOpnameSummaryDataProvider>();
        ...
        [WebGet]
        public IQueryable<vStockOpnameSummary> fStockOpnameSummaries()
        {
            return CurrentDataSource.fStockOpnameSummary(
