...
namespace Dismoyo.Ciptoning.Web.Services
{
    ...
    public partial class DataService : EntityFrameworkDataService<StoreFunctionsDataContext>, IServiceProvider
    {
        ...
        [QueryInterceptor("vSiteProducts")]
        public Expression<Func<vSiteProduct, bool>> OnQueryvSiteProducts()
        {
            return (p => true);
        }

        [ChangeInterceptor("vSiteProducts")]
        public void OnChangevSiteProducts(vSiteProduct data, UpdateOperations operations)
        {
            if (ValidateSegment("vSiteProducts"))
            {
                var dataProvider = DataConfiguration.GetDefaultDataProvider<IvSiteProductDataProvider>();
