...
namespace Dismoyo.Ciptoning.Web.Services
{
    ...
    public partial class DataService : EntityFrameworkDataService<StoreFunctionsDataContext>, IServiceProvider
    {
        ...
        [QueryInterceptor("vStockReceiveDetails")]
        public Expression<Func<vStockReceiveDetails, bool>> OnQueryvStockReceiveDetails()
        {
            return (p => true);
        }

        [ChangeInterceptor("vStockReceiveDetails")]
        public void OnChangevStockReceiveDetails(vStockReceiveDetails data, UpdateOperations operations)
        {
            if (ValidateSegment("vStockReceiveDetails"))
            {
                var dataProvider = DataConfiguration.GetDefaultDataProvider<IvStockReceiveDetailsDataProvider>();
        ...
        {
            return CurrentDataSource.fStockReceiveDetails(
