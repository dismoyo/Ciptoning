...
namespace Dismoyo.Ciptoning.Web.Services
{
    ...
    public partial class DataService : EntityFrameworkDataService<StoreFunctionsDataContext>, IServiceProvider
    {
        ...
        [QueryInterceptor("vSalesOrderReturnSummaries")]
        public Expression<Func<vSalesOrderReturnSummary, bool>> OnQueryvSalesOrderReturnSummaries()
        {
            return (p => true);
        }

        [ChangeInterceptor("vSalesOrderReturnSummaries")]
        public void OnChangevSalesOrderReturnSummaries(vSalesOrderReturnSummary data, UpdateOperations operations)
        {
            if (ValidateSegment("vSalesOrderReturnSummaries"))
            {
                var dataProvider = DataConfiguration.GetDefaultDataProvider<IvSalesOrderReturnSummaryDataProvider>();
        ...
        [WebGet]
        public IQueryable<vSalesOrderReturnSummary> fSalesOrderReturnSummaries()
        {
            return CurrentDataSource.fSalesOrderReturnSummary(
