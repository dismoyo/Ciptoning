...
namespace Dismoyo.Ciptoning.Web.Services
{
    ...
    public partial class DataService : EntityFrameworkDataService<StoreFunctionsDataContext>, IServiceProvider
    {
        ...
        [QueryInterceptor("vSyncHistories")]
        public Expression<Func<vSyncHistory, bool>> OnQueryvSyncHistories()
        {
            return (p => true);
        }

        [ChangeInterceptor("vSyncHistories")]
        public void OnChangevSyncHistories(vSyncHistory data, UpdateOperations operations)
        {
            var dataProvider = DataConfiguration.GetDefaultDataProvider<IvSyncHistoryDataProvider>();
