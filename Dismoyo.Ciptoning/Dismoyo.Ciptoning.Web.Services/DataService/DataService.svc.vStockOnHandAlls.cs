...
namespace Dismoyo.Ciptoning.Web.Services
{
    ...
    public partial class DataService : EntityFrameworkDataService<StoreFunctionsDataContext>, IServiceProvider
    {
        ...
        [QueryInterceptor("vStockOnHandAlls")]
        public Expression<Func<vStockOnHandAll, bool>> OnQueryvStockOnHandAlls()
        {
            return (p => true);
        }

        [ChangeInterceptor("vStockOnHandAlls")]
        public void OnChangevStockOnHandAlls(vStockOnHandAll data, UpdateOperations operations)
        {
            var dataProvider = DataConfiguration.GetDefaultDataProvider<IvStockOnHandAllDataProvider>();
