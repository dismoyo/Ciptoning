...
namespace Dismoyo.Ciptoning.Web.Services
{
    ...
    public partial class DataService : EntityFrameworkDataService<StoreFunctionsDataContext>, IServiceProvider
    {
        ...
        [QueryInterceptor("vRegions")]
        public Expression<Func<vRegion, bool>> OnQueryvRegions()
        {
            return (p => !p.IsDeleted);
        }

        [ChangeInterceptor("vRegions")]
        public void OnChangevRegions(vRegion data, UpdateOperations operations)
        {
            var dataProvider = DataConfiguration.GetDefaultDataProvider<IvRegionDataProvider>();
