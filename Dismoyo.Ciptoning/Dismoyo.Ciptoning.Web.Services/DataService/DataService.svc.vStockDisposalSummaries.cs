...
namespace Dismoyo.Ciptoning.Web.Services
{
    ...
    public partial class DataService : EntityFrameworkDataService<StoreFunctionsDataContext>, IServiceProvider
    {
        ...
        [QueryInterceptor("vStockDisposalSummaries")]
        public Expression<Func<vStockDisposalSummary, bool>> OnQueryvStockDisposalSummaries()
        {
            return (p => true);
        }

        [ChangeInterceptor("vStockDisposalSummaries")]
        public void OnChangevStockDisposalSummaries(vStockDisposalSummary data, UpdateOperations operations)
        {
            if (ValidateSegment("vStockDisposalSummaries"))
            {
                var dataProvider = DataConfiguration.GetDefaultDataProvider<IvStockDisposalSummaryDataProvider>();
        ...
        [WebGet]
        public IQueryable<vStockDisposalSummary> fStockDisposalSummaries()
        {
            return CurrentDataSource.fStockDisposalSummary(
