...
namespace Dismoyo.Ciptoning.Web.Services
{
    ...
    public partial class DataService : EntityFrameworkDataService<StoreFunctionsDataContext>, IServiceProvider
    {
        ...
        [QueryInterceptor("vProductLots")]
        public Expression<Func<vProductLot, bool>> OnQueryvProductLots()
        {
            return (p => !p.IsDeleted);
        }

        [ChangeInterceptor("vProductLots")]
        public void OnChangevProductLots(vProductLot data, UpdateOperations operations)
        {
            var dataProvider = DataConfiguration.GetDefaultDataProvider<IvProductLotDataProvider>();
