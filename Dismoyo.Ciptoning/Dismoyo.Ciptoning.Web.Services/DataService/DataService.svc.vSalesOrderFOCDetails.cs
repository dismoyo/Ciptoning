...
namespace Dismoyo.Ciptoning.Web.Services
{
    ...
    public partial class DataService : EntityFrameworkDataService<StoreFunctionsDataContext>, IServiceProvider
    {
        ...
        [QueryInterceptor("vSalesOrderFOCDetails")]
        public Expression<Func<vSalesOrderFOCDetails, bool>> OnQueryvSalesOrderFOCDetails()
        {
            return (p => true);
        }

        [ChangeInterceptor("vSalesOrderFOCDetails")]
        public void OnChangevSalesOrderFOCDetails(vSalesOrderFOCDetails data, UpdateOperations operations)
        {
            if (ValidateSegment("vSalesOrderFOCDetails"))
            {
                var dataProvider = DataConfiguration.GetDefaultDataProvider<IvSalesOrderFOCDetailsDataProvider>();
        ...
        {
            return CurrentDataSource.fSalesOrderFOCDetails(
