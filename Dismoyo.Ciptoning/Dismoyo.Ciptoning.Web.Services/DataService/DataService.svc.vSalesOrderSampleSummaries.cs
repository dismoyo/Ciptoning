...
namespace Dismoyo.Ciptoning.Web.Services
{
    ...
    public partial class DataService : EntityFrameworkDataService<StoreFunctionsDataContext>, IServiceProvider
    {
        ...
        [QueryInterceptor("vSalesOrderSampleSummaries")]
        public Expression<Func<vSalesOrderSampleSummary, bool>> OnQueryvSalesOrderSampleSummaries()
        {
            return (p => true);
        }

        [ChangeInterceptor("vSalesOrderSampleSummaries")]
        public void OnChangevSalesOrderSampleSummaries(vSalesOrderSampleSummary data, UpdateOperations operations)
        {
            if (ValidateSegment("vSalesOrderSampleSummaries"))
            {
                var dataProvider = DataConfiguration.GetDefaultDataProvider<IvSalesOrderSampleSummaryDataProvider>();
        ...
        [WebGet]
        public IQueryable<vSalesOrderSampleSummary> fSalesOrderSampleSummaries()
        {
            return CurrentDataSource.fSalesOrderSampleSummary(
