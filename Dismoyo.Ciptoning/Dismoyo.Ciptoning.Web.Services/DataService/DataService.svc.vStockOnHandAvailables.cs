...
namespace Dismoyo.Ciptoning.Web.Services
{
    ...
    public partial class DataService : EntityFrameworkDataService<StoreFunctionsDataContext>, IServiceProvider
    {
        ...
        [QueryInterceptor("vStockOnHandAvailables")]
        public Expression<Func<vStockOnHandAvailable, bool>> OnQueryvStockOnHandAvailables()
        {
            return (p => true);
        }

        [ChangeInterceptor("vStockOnHandAvailables")]
        public void OnChangevStockOnHandAvailables(vStockOnHandAvailable data, UpdateOperations operations)
        {
            var dataProvider = DataConfiguration.GetDefaultDataProvider<IvStockOnHandAvailableDataProvider>();
