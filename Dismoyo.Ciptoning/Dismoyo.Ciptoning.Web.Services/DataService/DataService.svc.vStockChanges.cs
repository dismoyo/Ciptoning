...
namespace Dismoyo.Ciptoning.Web.Services
{
    ...
    public partial class DataService : EntityFrameworkDataService<StoreFunctionsDataContext>, IServiceProvider
    {
        ...
        [QueryInterceptor("vStockChanges")]
        public Expression<Func<vStockChanges, bool>> OnQueryvStockChanges()
        {
            return (p => true);
        }

        [ChangeInterceptor("vStockChanges")]
        public void OnChangevStockChanges(vStockChanges data, UpdateOperations operations)
        {
            var dataProvider = DataConfiguration.GetDefaultDataProvider<IvStockChangesDataProvider>();
        ...
        {
            return CurrentDataSource.fStockChanges(
                ...
                (int?)GetQueryFilterParameterValue("OldItemStatusID"),
                (int?)GetQueryFilterParameterValue("NewItemStatusID"),
