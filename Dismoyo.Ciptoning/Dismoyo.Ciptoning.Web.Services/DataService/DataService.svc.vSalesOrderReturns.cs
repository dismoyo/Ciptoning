...
namespace Dismoyo.Ciptoning.Web.Services
{
    ...
    public partial class DataService : EntityFrameworkDataService<StoreFunctionsDataContext>, IServiceProvider
    {
        ...
        [QueryInterceptor("vSalesOrderReturns")]
        public Expression<Func<vSalesOrderReturn, bool>> OnQueryvSalesOrderReturns()
        {
            return (p => true);
        }

        [ChangeInterceptor("vSalesOrderReturns")]
        public void OnChangevSalesOrderReturns(vSalesOrderReturn data, UpdateOperations operations)
        {
            var dataProvider = DataConfiguration.GetDefaultDataProvider<IvSalesOrderReturnDataProvider>();
                    ...
                    using (var transaction = DefaultDataContext.DataContext.Database.BeginTransaction())
                    {
                        try
                        {
                            ...
                            if ((prevDocumentStatusID != data.DocumentStatusID) && (data.DocumentStatusID == 2)) // Posted
                                DefaultDataContext.SalesOrderReturnExt(data.DocumentID);
                        }
                        catch (Exception ex)
                        {
        ...
        [WebGet]
        public IQueryable<vSalesOrderReturn> fSalesOrderReturns()
        {
            return CurrentDataSource.fSalesOrderReturn(
                ...
                (int?)GetQueryFilterParameterValue("ReasonID"),
