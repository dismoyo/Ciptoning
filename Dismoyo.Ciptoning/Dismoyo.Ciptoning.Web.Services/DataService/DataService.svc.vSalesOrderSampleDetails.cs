...
namespace Dismoyo.Ciptoning.Web.Services
{
    ...
    public partial class DataService : EntityFrameworkDataService<StoreFunctionsDataContext>, IServiceProvider
    {
        ...
        [QueryInterceptor("vSalesOrderSampleDetails")]
        public Expression<Func<vSalesOrderSampleDetails, bool>> OnQueryvSalesOrderSampleDetails()
        {
            return (p => true);
        }

        [ChangeInterceptor("vSalesOrderSampleDetails")]
        public void OnChangevSalesOrderSampleDetails(vSalesOrderSampleDetails data, UpdateOperations operations)
        {
            if (ValidateSegment("vSalesOrderSampleDetails"))
            {
                var dataProvider = DataConfiguration.GetDefaultDataProvider<IvSalesOrderSampleDetailsDataProvider>();
        ...
        {
            return CurrentDataSource.fSalesOrderSampleDetails(
