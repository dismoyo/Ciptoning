...
namespace Dismoyo.Ciptoning.Web.Services
{
    ...
    public partial class DataService : EntityFrameworkDataService<StoreFunctionsDataContext>, IServiceProvider
    {
        ...
        [QueryInterceptor("vProductBrands")]
        public Expression<Func<vProductBrand, bool>> OnQueryvProductBrands()
        {
            return (p => !p.IsDeleted);
        }

        [ChangeInterceptor("vProductBrands")]
        public void OnChangevProductBrands(vProductBrand data, UpdateOperations operations)
        {
            var dataProvider = DataConfiguration.GetDefaultDataProvider<IvProductBrandDataProvider>();
