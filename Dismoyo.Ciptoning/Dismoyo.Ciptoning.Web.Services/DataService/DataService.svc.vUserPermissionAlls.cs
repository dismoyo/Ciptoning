...
namespace Dismoyo.Ciptoning.Web.Services
{
    ...
    public partial class DataService : EntityFrameworkDataService<StoreFunctionsDataContext>, IServiceProvider
    {
        ...
        [QueryInterceptor("vUserPermissionAlls")]
        public Expression<Func<vUserPermissionAll, bool>> OnQueryvUserPermissionAlls()
        {
            return (p => true);
        }

        [ChangeInterceptor("vUserPermissionAlls")]
        public void OnChangevUserPermissionAlls(vUserPermissionAll data, UpdateOperations operations)
        {
            var dataProvider = DataConfiguration.GetDefaultDataProvider<IvUserPermissionAllDataProvider>();
