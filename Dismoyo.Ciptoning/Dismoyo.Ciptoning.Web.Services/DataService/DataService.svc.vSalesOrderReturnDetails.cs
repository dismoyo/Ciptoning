...
namespace Dismoyo.Ciptoning.Web.Services
{
    ...
    public partial class DataService : EntityFrameworkDataService<StoreFunctionsDataContext>, IServiceProvider
    {
        ...
        [QueryInterceptor("vSalesOrderReturnDetails")]
        public Expression<Func<vSalesOrderReturnDetails, bool>> OnQueryvSalesOrderReturnDetails()
        {
            return (p => true);
        }

        [ChangeInterceptor("vSalesOrderReturnDetails")]
        public void OnChangevSalesOrderReturnDetails(vSalesOrderReturnDetails data, UpdateOperations operations)
        {
            if (ValidateSegment("vSalesOrderReturnDetails"))
            {
                var dataProvider = DataConfiguration.GetDefaultDataProvider<IvSalesOrderReturnDetailsDataProvider>();
        ...
        {
            return CurrentDataSource.fSalesOrderReturnDetails(
