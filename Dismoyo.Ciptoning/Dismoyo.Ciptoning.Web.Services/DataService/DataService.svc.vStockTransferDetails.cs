...
namespace Dismoyo.Ciptoning.Web.Services
{
    ...
    public partial class DataService : EntityFrameworkDataService<StoreFunctionsDataContext>, IServiceProvider
    {
        ...
        [QueryInterceptor("vStockTransferDetails")]
        public Expression<Func<vStockTransferDetails, bool>> OnQueryvStockTransferDetails()
        {
            return (p => true);
        }

        [ChangeInterceptor("vStockTransferDetails")]
        public void OnChangevStockTransferDetails(vStockTransferDetails data, UpdateOperations operations)
        {
            if (ValidateSegment("vStockTransferDetails"))
            {
                var dataProvider = DataConfiguration.GetDefaultDataProvider<IvStockTransferDetailsDataProvider>();
        ...
        {
            return CurrentDataSource.fStockTransferDetails(
