...
IF EXISTS(SELECT * FROM sys.objects
    WHERE object_id = OBJECT_ID(N'[dbo].[spSalesOrderSampleExt]') AND type IN ( N'P'))
    DROP PROCEDURE [dbo].[spSalesOrderSampleExt];
GO

-- ===================================================================================
-- Author        : System
-- Created date  : 20 Mar 2016 23:32:11
-- Description   : Provide procedure to create [dbo].[SalesOrderSampleExt] data as history of
--                 [dbo].[SalesOrderSample]
-- ===================================================================================

CREATE PROCEDURE [dbo].[spSalesOrderSampleExt]
(
...
BEGIN
    ...
    SELECT
            @RetDocumentID = [fSOS].[DocumentID],
            @DocumentCode = [fSOS].[DocumentCode],
            @TransactionDate = [fSOS].[TransactionDate],
            ...
            @TermOfPaymentName = [fSOS].[TermOfPaymentName],
        ...
        FROM
            ...
            (
                ...
                NULL,
                NULL
            ) [fS] ON ([fSOS].[SalesmanID] = [fS].[ID]) INNER JOIN
            [dbo].[fCustomer]
            (
                NULL,
                NULL,
