...
IF EXISTS(SELECT * FROM sys.objects
    WHERE object_id = OBJECT_ID(N'[dbo].[spSalesOrderSwapExt]') AND type IN ( N'P'))
    DROP PROCEDURE [dbo].[spSalesOrderSwapExt];
GO

-- ===================================================================================
-- Author        : System
-- Created date  : 20 Mar 2016 23:32:11
-- Description   : Provide procedure to create [dbo].[SalesOrderSwapExt] data as history of
--                 [dbo].[SalesOrderSwap]
-- ===================================================================================

CREATE PROCEDURE [dbo].[spSalesOrderSwapExt]
(
