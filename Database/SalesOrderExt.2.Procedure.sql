...
IF EXISTS(SELECT * FROM sys.objects
    WHERE object_id = OBJECT_ID(N'[dbo].[spSalesOrderExt]') AND type IN ( N'P'))
    DROP PROCEDURE [dbo].[spSalesOrderExt];
GO

-- ===================================================================================
-- Author        : System
-- Created date  : 20 Mar 2016 23:32:11
-- Description   : Provide procedure to create [dbo].[SalesOrderExt] data as history of
--                 [dbo].[SalesOrder]
-- ===================================================================================

CREATE PROCEDURE [dbo].[spSalesOrderExt]
(
...
BEGIN
    ...
    SELECT
            @RetDocumentID = [fSO].[DocumentID],
            @DocumentCode = [fSO].[DocumentCode],
            @TransactionDate = [fSO].[TransactionDate],
            ...
            @TermOfPaymentName = [fSO].[TermOfPaymentName],
        ...
        FROM
            ...
            (
                ...
                NULL,
                NULL
            ) [fS] ON ([fSO].[SalesmanID] = [fS].[ID]) INNER JOIN
            [dbo].[fCustomer]
            (
                NULL,
                NULL,
