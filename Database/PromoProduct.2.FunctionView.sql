...
IF EXISTS(SELECT * FROM sys.objects
    WHERE object_id = OBJECT_ID(N'[dbo].[fPromoProduct]') AND type IN ( N'FN', N'IF', N'TF', N'FS', N'FT'))
    DROP FUNCTION [dbo].[fPromoProduct];
GO

-- ===================================================================================
-- Author        : System
-- Created date  : 20 Mar 2016 22:02:31
-- Description   : Provide function to retrieve [dbo].[PromoProduct] data.
--
-- NOTE: This Function is initially generated by system and can be modified following
--       the requirement.
-- ===================================================================================

CREATE FUNCTION [dbo].[fPromoProduct]
(
    @ID int,
    @Code nvarchar(20),
    @ProductID int,
...
(
	SELECT
            ...
            [PP].[IsDeleted]
        FROM
			[dbo].[PromoProduct] [PP] INNER JOIN
            [dbo].[fProduct]
            (
                @ProductID,
                @ProductCode,
            ...
            (
                ...
                NULL,
                NULL
            ) [fSL] ON ([PP].[TermOfPaymentID] = [fSL].[Value_Int32]) LEFT OUTER JOIN
            [dbo].[fSystemLookup]
            (
                NULL,
                NULL,
		...
		WHERE
            ...
            ((@TermOfPaymentID IS NULL) OR ([PP].[TermOfPaymentID] = @TermOfPaymentID)) AND
...
IF EXISTS(SELECT * FROM sys.objects
    WHERE object_id = OBJECT_ID(N'[dbo].[vPromoProduct]') AND type IN ( N'V' ))
    DROP VIEW [dbo].[vPromoProduct];
GO

-- ===================================================================================
-- Author        : System
-- Created date  : 20 Mar 2016 22:02:32
-- Description   : Provide view (model) to retrieve [dbo].[fPromoProduct] data.
--
-- NOTE: This View is initially generated by system and can be modified following
--       the requirement.
-- ===================================================================================

CREATE VIEW [dbo].[vPromoProduct]
AS
(
    SELECT
            [ID],
