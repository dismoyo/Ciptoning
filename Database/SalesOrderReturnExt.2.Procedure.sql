...
IF EXISTS(SELECT * FROM sys.objects
    WHERE object_id = OBJECT_ID(N'[dbo].[spSalesOrderReturnExt]') AND type IN ( N'P'))
    DROP PROCEDURE [dbo].[spSalesOrderReturnExt];
GO

-- ===================================================================================
-- Author        : System
-- Created date  : 20 Mar 2016 23:32:11
-- Description   : Provide procedure to create [dbo].[SalesOrderReturnExt] data as history of
--                 [dbo].[SalesOrderReturn]
-- ===================================================================================

CREATE PROCEDURE [dbo].[spSalesOrderReturnExt]
(
...
BEGIN
    ...
    SELECT
            @RetDocumentID = [fSOR].[DocumentID],
            @DocumentCode = [fSOR].[DocumentCode],
            @TransactionDate = [fSOR].[TransactionDate],
            ...
            @TermOfPaymentName = [fSOR].[TermOfPaymentName],
        ...
        FROM
            ...
            (
                ...
                NULL,
                NULL
            ) [fS] ON ([fSOR].[SalesmanID] = [fS].[ID]) INNER JOIN
            [dbo].[fCustomer]
            (
                NULL,
                NULL,
